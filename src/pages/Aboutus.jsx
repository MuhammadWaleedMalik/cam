  ...
  return (
    <div className="min-h-screen bg-white pt-24 pb-16 px-6 md:px-20">
      ...
      >
        ...
        >
          About <span style={{ color: colors.primary }}>CemedBidAi</span>
        </h1>
      ...
      >
        ...
        <div className="md:w-1/2">
          ...
          <p className="text-lg leading-relaxed text-[#A1A1AA]">
            At CemedBidAi, we believe creativity should be accessible to everyone.
            ...
            — quickly, intuitively, and affordably. We aim to democratize
            Bids creation for all.
          </p>
        </div>
      </motion.section>
      ...
      >
        ...
        <p className="text-lg text-[#A1A1AA] max-w-2xl mx-auto mb-8">
          ...
          to have you with us! Explore RunwayML today and bring your stories to life
